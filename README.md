...
1. Clone o repositório
  * `git clone https://github.com/tryber/sd-014-a-trybe-futebol-clube.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-014-a-trybe-futebol-clube`
...
3. Crie uma branch a partir da branch `master`
  ...
  * Agora crie uma branch à qual você vai submeter os `commits` do seu projeto
    ...
    * Exemplo: `git checkout -b joaozinho-sd-014-a-trybe-futebol-clube`
...
5. Adicione a sua branch com o novo `commit` ao repositório remoto
  * Usando o exemplo anterior: `git push -u origin joaozinho-sd-014-a-trybe-futebol-clube`
...
- `sd-014-a-trybe-futebol-clube/app/backend/package.json`
